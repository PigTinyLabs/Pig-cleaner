...
def process_image(img_path, cols, rows, output_dir, prefix, row_start=0, row_end=None):
...
# Run for both
process_image('/Users/tiny/Downloads/dog-spirte.png', 8, 4, './src/renderer/assets/sprites/dog', 'dog', 0, 4)
process_image('/Users/tiny/Downloads/dog-eat-dog-sleep.png', 8, 4, './src/renderer/assets/sprites/dog_extra', 'dog_extra', 1, 3)
print('Flood fill processing done!')

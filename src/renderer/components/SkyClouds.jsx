...
export default function SkyClouds({ altitude }) {
  ...
  const stars = [
    ...
    { id: 5, x: '45%', y: 3500, size: '30px', type: '🌌', opacity: 0.8 },
    { id: 6, x: '10%', y: 4000, size: '22px', type: '🌟', opacity: 0.9 },
    { id: 7, x: '75%', y: 4500, size: '20px', type: '✨', opacity: 0.7 },
    { id: 8, x: '30%', y: 5000, size: '40px', type: '🌌', opacity: 0.8 },
    ...
    { id: 12, x: '65%', y: 7000, size: '45px', type: '🌌', opacity: 1.0 },
  ]
  ...
  return (
    ...
    >
      {clouds.map(cloud => {
        ...
        const currentY = cloud.y - (altitude * cloudScrollSpeed)
        ...
        return (
          <div 
            ...
            style={{
              ...
              transition: 'bottom 0.1s linear', // mượt mà
      ...
      {stars.map(star => {
        const currentY = star.y - (altitude * starScrollSpeed)
